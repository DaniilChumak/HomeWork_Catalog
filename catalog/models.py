...
class Category(models.Model):
    name = models.CharField(
        max_length=50, verbose_name="Название категории", help_text="Укажите категорию"
    )
...
class Product(models.Model):
    ...
    price = models.FloatField(
        verbose_name="Стоимость", help_text="Укажите стоимость товара"
    )
